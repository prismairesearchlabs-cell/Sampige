#!/usr/bin/env python3
"""
Working Test Script for SaMPiGe-Distill
Tests core components directly without package installation
"""
...
try:
    ...
    spec = importlib.util.spec_from_file_location("models.student", "models/student.py")
    student_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(student_module)
    
    StudentBackbone = student_module.StudentBackbone
...
try:
    spec = importlib.util.spec_from_file_location("models.projection", "models/projection.py")
    projection_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(projection_module)
    
    ProjectionHead = projection_module.ProjectionHead
...
try:
    spec = importlib.util.spec_from_file_location("models.prototype", "models/prototype.py")
    prototype_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(prototype_module)
    
    PrototypeModule = prototype_module.PrototypeModule
...
try:
    spec = importlib.util.spec_from_file_location("losses", "losses.py")
    losses_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(losses_module)
    
    DetectionLoss = losses_module.DetectionLoss
    CIoULoss = losses_module.CIoULoss
    KnowledgeDistillationLoss = losses_module.KnowledgeDistillationLoss
...
try:
    ...
    DynamicWeightScheduler = scheduler_module.DynamicWeightScheduler
    LambdaScheduler = scheduler_module.LambdaScheduler
...
try:
    ...
    spec = importlib.util.spec_from_file_location("utils.metrics", "utils/metrics.py")
    metrics_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(metrics_module)
    
    DetectionMetrics = metrics_module.DetectionMetrics
...
try:
    ...
    # Import distiller
    spec = importlib.util.spec_from_file_location("models.distiller", "models/distiller.py")
    distiller_module = importlib.util.module_from_spec(spec)
    spec.loader.exec_module(distiller_module)
    
    KnowledgeDistiller = distiller_module.KnowledgeDistiller
